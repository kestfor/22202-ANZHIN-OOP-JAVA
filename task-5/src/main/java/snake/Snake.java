...
public class Snake {
    ...
    private static Pair<Integer, Integer> getCoords(Field field, Cell cell) {
    ...
    public ArrayList<Pair<Integer, Integer>> getSnakeCoords(Field field) {
        ArrayList<Pair<Integer, Integer>> coords = new ArrayList<>();
        for (Cell cell : body) {
            coords.add(getCoords(field, cell));
        }
        return coords;
    }
    ...
    public void setBody(Field field, ArrayList<Pair<Integer, Integer>> newCoords) {
        body.clear();
        for (Pair<Integer, Integer> coords : newCoords) {
            add(field.getCell(coords.second, coords.first));
        }
    }
